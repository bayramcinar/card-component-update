...
function App() {
  ...
  return (
    <div className="App bg-bgColour">
      ...
      <div  className='cardArea m-5 flex overflow-x-auto transition-all duration-1500 ease-in-out ml-auto mr-auto touch-pan-x max-w-screen-lg' ref={cardAreaRef} style={{ scrollBehavior: 'smooth', touchAction: 'pan-x', overflow: isMobile() ? '' : 'hidden' }}> 
